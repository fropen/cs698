...
public class WordCount {
  ...
  public static class ReducerMapper extends Mapper<Text, IntWritable, IntWritable, Text> {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ChainReducer.addMapper(job, ReducerMapper.class, Text.class, IntWritable.class,
